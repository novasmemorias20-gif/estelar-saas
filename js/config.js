...
export const SUPABASE_URL = "https://lkankciqsldutuncuvyl.supabase.co";
export const SUPABASE_ANON_KEY = "sb_publishable_QAzF6HlUkYoAumTQCzKuVg_FEmhtwQ8";
export const PLANO_PRECOS = { basico: { mensal: 39.90, anual: 399.00 }, completo: { mensal: 129.90, anual: 1299.00 } };
